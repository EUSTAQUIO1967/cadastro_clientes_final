export class Utils {
    ...
    static validaCPF: boolean = (strCPF: string | any ) => {
    ...
    static mascTelefone: string = (telefone: string) => {
    ...
    static mascCPF: string = (cpf: string) => {
    ...
    static validarCampos: Array = (campos: NodeList) => {
    ...
    static criaTd = () => document.createElement('td');
